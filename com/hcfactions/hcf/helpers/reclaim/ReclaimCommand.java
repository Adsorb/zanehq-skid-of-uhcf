package com.hcfactions.hcf.helpers.reclaim;
...
import com.hcfactions.hcf.util.Color;
...
public class ReclaimCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command arg1, String arg2, String[] args) {
		...
		if(rm.getReclaim(rank).size()==0) {
			player.sendMessage(Color.translate("&cYour rank's reclaim hasn't been setup yet. Please contact an admin."));
			return false;
		}
		...
		player.sendMessage(Color.translate("&3&lYou have reclaimed your rank."));
