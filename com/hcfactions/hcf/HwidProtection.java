...
public class HwidProtection {
    ...
    public boolean register(){
        log(0, ChatColor.YELLOW.toString() + "------------------------------");
        log(0, ChatColor.BLUE + "Connecting to HWID-Server...");
        ValidationType vt = isValid();
        if(vt == ValidationType.VALID){
            log(0, ChatColor.YELLOW.toString() + "------------------------------");
            log(1, ChatColor.GOLD.toString() + "HWID" + ChatColor.GRAY.toString() + ": " + ChatColor.WHITE + Base.config.getString("HWID"));
            log(1, ChatColor.GOLD.toString() + "Status" + ChatColor.GRAY.toString() + ": " + ChatColor.GREEN + "Valid");
            log(1, ChatColor.BLUE + "Enjoy the plugin ;)");
            log(0, ChatColor.YELLOW.toString() + "------------------------------");
            return true;
        }else{
            /*
            ...
            log(0, ChatColor.YELLOW.toString() + "------------------------------");
            log(1, ChatColor.GOLD.toString() + "HWID" + ChatColor.GRAY.toString() + ": " + ChatColor.WHITE + Base.config.getString("HWID"));
            log(1, ChatColor.GOLD.toString() + "Status" + ChatColor.GRAY.toString() + ": " + ChatColor.RED + "Invalid");
            log(1, ChatColor.BLUE + "If you think this is a mistake contact Cathnor");
            log(0, ChatColor.YELLOW.toString() + "------------------------------");
