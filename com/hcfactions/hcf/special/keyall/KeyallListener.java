package com.hcfactions.hcf.special.keyall;
...
public class KeyallListener implements Listener {
    ...
    public static class RebootRunnable extends BukkitRunnable {
        ...
        private KeyallListener rebootTimer;
        private long startMillis;
        private static long endMillis;

        @SuppressWarnings("static-access")
		public RebootRunnable(KeyallListener rebootTimer, long duration) {
