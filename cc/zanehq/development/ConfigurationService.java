...
public final class ConfigurationService {
	...
	public static final boolean TALIBAN_PEARLS = Base.config.getBoolean("TALIBAN-PEARLS");
	public static final String MAP_KIT = Base.config.getString("MAP-KIT");
	public static final String Faction_SIZE = Base.config.getString("FACTION-SIZE");
	public static final String FOOTERTEXT = Base.config.getString("Footer.text");
	public static final boolean FOOTER = Base.getPlugin().config.getBoolean("Footer.enabled");
	public static final boolean UHCF = Base.getPlugin().config.getBoolean("UHCF.mode.enabled");
	public static final String SERVER_NAME = Base.config.getString("MAP-NUMBER");
	public static final String WEBSITE_URL = Base.config.getString("Website");
	public static final String SCMSG = Base.config.getString("StaffChat.Message");
	public static final String MCMSG = Base.config.getString("MediaChat.Message");
	public static final String BLOCKED_POTIONS = Base.config.getString("blocked-potions");
	public static final boolean TAB_LIST = Base.config.getBoolean("TAB-LIST");
	...
	public static final String MAP_NUMBER = Base.config.getString("MAP-NUMBER");
...
//	public static final boolean GET_POTS_FREE = Base.getPlugin().config.getBoolean("get_pots_free");
	...
	public static final String PRIMAIRY_COLOR = Base.getPlugin().getConfig().getString("Colours.PRIMARY-COLOR").replace("&", "§");
	public static final String SECONDAIRY_COLOR = Base.getPlugin().getConfig().getString("Colours.SECONDARY-COLOR").replace("&", "§");
	public static final String THIRD_COLOR = Base.getPlugin().getConfig().getString("Colours.TERTIARY-COLOR").replace("&", "§");
	...
	public static final String SCOREBOARD_TITLE = ChatColor.translateAlternateColorCodes('&',
			Base.config.getString("Scoreboard.Title.Name"));
